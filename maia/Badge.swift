...
class BadgeManager: ObservableObject {
    ...
    private func initializeBadges() {
        badges = [
            ...
            Badge(name: "Head Of The Ambitious Poets Department", description: "Learn 200 words", iconName: "book.fill", requirement: "Learn 200 words"),
            Badge(name: "Shakespeare is Calling", description: "Learn 300 words", iconName: "book.fill", requirement: "Learn 300 words")
        ]
    }
